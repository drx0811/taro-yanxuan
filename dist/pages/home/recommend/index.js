...
var Recommend = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Recommend() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Recommend.__proto__ || Object.getPrototypeOf(Recommend)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "$anonymousCallee__0", "defaultAvatar", "list"], _this.handleClick = function (id) {
  ...
  _createClass(Recommend, [{
    ...
    value: function _createData() {
      ...
      var $anonymousCallee__0 = list.filter(function (item) {
        return item.type === 1;
      });
      var loopArray0 = list.filter(function (item) {
        return item.type === 1;
      }).map(function (item) {
        item = {
        ...
        var _item$$original = item.$original,
            id = _item$$original.id,
            categoryItem = _item$$original.categoryItem;

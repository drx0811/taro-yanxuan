...
var Policy = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Policy() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Policy.__proto__ || Object.getPrototypeOf(Policy)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["list"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }

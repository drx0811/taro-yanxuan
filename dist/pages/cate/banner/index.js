...
var Banner = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Banner() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Banner.__proto__ || Object.getPrototypeOf(Banner)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$anonymousCallee__0", "banner"], _this.handleClick = function () {
  ...
  _createClass(Banner, [{
    ...
    value: function _createData() {
      ...
      var $anonymousCallee__0 = banner.slice(0, 1);

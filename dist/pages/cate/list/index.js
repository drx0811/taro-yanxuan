...
var List = (_temp2 = _class = function (_BaseComponent) {
  ...
  function List() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = List.__proto__ || Object.getPrototypeOf(List)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "list"], _this.handleClick = function (item) {
  ...
  _createClass(List, [{
    ...
    value: function _createData() {
      ...
      var loopArray0 = list.map(function (group) {
        group = {
          $original: (0, _index.internal_get_original)(group)
        };
        var $anonymousCallee__0 = group.$original.categoryList.map(function (item, index) {
          item = {
            $original: (0, _index.internal_get_original)(item)
          };
          var $loopState__temp2 = (0, _index4.default)('cate-list__item', { 'cate-list__item--right': (index + 1) % 3 === 0 });
          return {

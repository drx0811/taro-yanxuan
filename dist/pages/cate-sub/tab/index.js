...
var Banner = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Banner() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Banner.__proto__ || Object.getPrototypeOf(Banner)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["list", "current", "__fn_onChange"], _this.handleClick = function (index) {
      _this.__triggerPropsFn("onChange", [null].concat([index]));

...
var Loading = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Loading() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loading.__proto__ || Object.getPrototypeOf(Loading)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loading"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
